...
function Profile() {
  ...
  return (
    <div className="profile-page">
      ...
      <h1>Julia Ivan</h1>
      <p className="description">Julia is a licensed Family Therapist in London.<br></br>
      She has been working in the mental health field for over ten years, <br></br> 
      and has experience working with adults, children and families who have experienced trauma.</p>
      ...
      {view && (
        <>
        <p>Pick a date and send me a message about what you would like to discuss with me. <br></br>
